...
public class BedwarsRespawnPlayer {
    ...
    public void respawnPlayer(Player player, int serverMap){
        ...
        if(serverMap==3){
            if(team.equalsIgnoreCase("red")){
                player.teleport(new Location(player.getWorld(), -6.5,-1,-6.5,0,0));
                player.setGameMode(GameMode.SURVIVAL);
                ItemStack helmet = new ItemStack(Material.LEATHER_HELMET);
                LeatherArmorMeta helmetMeta = (LeatherArmorMeta) helmet.getItemMeta();
                helmetMeta.setColor(Color.RED);
                ...
                player.teleport(new Location(player.getWorld(), -6.5,-1,-180.5,180,0));
                player.setGameMode(GameMode.SURVIVAL);
                ItemStack helmet = new ItemStack(Material.LEATHER_HELMET);
                LeatherArmorMeta helmetMeta = (LeatherArmorMeta) helmet.getItemMeta();
                helmetMeta.setColor(Color.YELLOW);
                ...
                player.teleport(new Location(player.getWorld(), 80.5,-1,-93.5,-90,0));
                player.setGameMode(GameMode.SURVIVAL);
                ItemStack helmet = new ItemStack(Material.LEATHER_HELMET);
                LeatherArmorMeta helmetMeta = (LeatherArmorMeta) helmet.getItemMeta();
                helmetMeta.setColor(Color.BLUE);
                ...
                player.teleport(new Location(player.getWorld(), -93,5,-93.5,90,0));
                player.setGameMode(GameMode.SURVIVAL);
                ItemStack helmet = new ItemStack(Material.LEATHER_HELMET);
                LeatherArmorMeta helmetMeta = (LeatherArmorMeta) helmet.getItemMeta();
                helmetMeta.setColor(Color.GREEN);
